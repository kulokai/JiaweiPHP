        ...
        <div class="padding-md">
            ...
            <div class="jw-box">
                <form>
                    ...
                    <input type="text" name="mod" placeholder="模块">
                    <input type="text" name="con" placeholder="控制器">
                    <input type="text" name="act" placeholder="操作">
                    <button>搜索</button>
                </form>
            </div>
            <div class="jw-box">
                <table class="table table-bordered table-hover">
                    ...
                    <?php if(is_array($node)): foreach($node as $key=>$vo): ?><tr>
...
<script>
    function delTip($id) {
        $('#sure-del-btn').attr('href','/Snow_php_admin_framework/index.php/Admin/Node/del/id/'+$id);
        $('#del-mb').modal();
    }
</script>
</div><!-- /wrapper -->
...
<script>
    setInterval(function () {
        $.ajax({
            url:'/Snow_php_admin_framework/index.php/Admin/Node/alive',
            type:'get',
